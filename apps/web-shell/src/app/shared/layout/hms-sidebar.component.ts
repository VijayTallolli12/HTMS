  ...
  template: `
    <nav class="hms-sidebar" [class.is-collapsed]="isCollapsed" aria-label="Main Navigation">
      ...
      <div class="hms-sidebar__nav">
        ...
        <!-- 6. PREFERENCES -->
        <div class="hms-sidebar__section">
          <div class="hms-sidebar__section-title" *ngIf="!isCollapsed">Preferences</div>
          ...
          <a
            ...
            [attr.aria-label]="'Appearance & Theme'"
          >
            <span class="hms-sidebar__item-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="hms-sidebar__item-label" *ngIf="!isCollapsed">Appearance</span>
          </a>
        </div>
      </div>
