...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    ...
    .addTag('Organization - Hotel Groups', 'Hotel group enterprise tier operations')
    .addTag('Organization - Regions', 'Geographical and operational regional clusters')
    .addTag('Organization - Countries', 'Jurisdictional country entities')
    .addTag('Organization - Properties', 'Hotel and resort operational units')
    .addTag('Organization - Buildings', 'Physical building towers and wings')
    .addTag('Organization - Floors', 'Physical floors and vertical level zones')
    .addTag('Organization - Hierarchy', 'Full recursive hierarchy tree navigation')
    .addBearerAuth()
